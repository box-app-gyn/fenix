...
const INITIAL_LINKS = [
  {
    ...
    title: 'Comprar Ingresso - CERRADØ INTERBOX 2025',
    description: 'Link oficial para compra de ingressos do CERRADØ INTERBOX 2025',
  ...
  },
  {
    ...
    title: 'Comunidade WhatsApp - CERRADØ INTERBOX',
    description: 'Entre na comunidade oficial do WhatsApp do CERRADØ INTERBOX 2025',
  ...
  },
  {
    ...
    shortCode: 'instagram',
    title: 'Instagram - CERRADØ INTERBOX',
    description: 'Siga o CERRADØ INTERBOX no Instagram para novidades',
  ...
  },
  {
    ...
    shortCode: 'facebook',
    title: 'Facebook - CERRADØ INTERBOX',
    description: 'Curta a página do CERRADØ INTERBOX no Facebook',
    category: 'midia' as const,
    isPublic: true,
    isActive: true,
  },
  {
    ...
    shortCode: 'youtube',
    title: 'YouTube - CERRADØ INTERBOX',
    description: 'Inscreva-se no canal do YouTube do CERRADØ INTERBOX',
    category: 'midia' as const,
    isPublic: true,
    isActive: true,
  },
