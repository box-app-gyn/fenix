        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm border">
              ...
              <p className="text-gray-600">
                Framework CSS utilitário para desenvolvimento rápido e design responsivo.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm border">
              ...
              <p className="text-gray-600">
                Framework React com SSR, roteamento e otimizações automáticas.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm border">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Firebase</h3>
              <p className="text-gray-600">
                Backend como serviço com autenticação, banco de dados e storage.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm border">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">PWA</h3>
              <p className="text-gray-600">
                Progressive Web App com funcionalidades offline e instalação nativa.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm border">
              ...
              <p className="text-gray-600">
                Configurações de segurança robustas e boas práticas implementadas.
              </p>
            </div>
          </div>
        </div>
