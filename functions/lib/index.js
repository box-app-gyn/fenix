...
// Importar funções de FlowPay
const {criarCheckoutFlowPay, webhookFlowPay} = require("./flowpay.js");
...
// Exportar funções de FlowPay
exports.criarCheckoutFlowPay = criarCheckoutFlowPay;
exports.webhookFlowPay = webhookFlowPay;
