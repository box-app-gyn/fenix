...
exports.enviarConviteTime = functions.https.onCall(async (data, context) => {
  ...
  try {
    ...
    logger_1.logger.business("Convite de time enviado", {teamId, userId}, contextData);
    return {success: true};
  } catch (error) {
    logger_1.logger.error("Erro ao enviar convite de time", {error: error.message}, contextData);
    throw error;
  }
});
exports.responderConviteTime = functions.https.onCall(async (data, context) => {
  ...
  try {
    ...
    logger_1.logger.business("Convite de time respondido", {inviteId, resposta}, contextData);
    return {success: true};
  } catch (error) {
    logger_1.logger.error("Erro ao responder convite de time", {error: error.message}, contextData);
    throw error;
  }
});
exports.listarConvitesUsuario = functions.https.onCall(async (data, context) => {
  ...
  try {
    ...
    logger_1.logger.error("Erro ao listar convites do usuário", {error: error.message}, contextData);
    throw error;
  }
});
exports.cancelarConviteTime = functions.https.onCall(async (data, context) => {
  ...
  try {
    ...
    logger_1.logger.business("Convite de time cancelado", {inviteId}, contextData);
    return {success: true};
  } catch (error) {
    logger_1.logger.error("Erro ao cancelar convite de time", {error: error.message}, contextData);
    throw error;
  }
});
